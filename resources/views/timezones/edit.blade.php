        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-6 mt-4">
            <div class="pb-6 mb-6 border-b border-gray-100">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h2 class="text-sm font-bold text-gray-900 leading-tight">Timezone Information</h2>
                        <p class="mt-0.5 text-xs text-gray-500">Please update the details of the timezone.</p>
                    </div>
                </div>

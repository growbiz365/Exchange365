<x-app-layout>
        ...
        <div class="relative flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4">
                <div class="relative flex-shrink-0">
                    <div class="bg-gradient-to-br from-sky-500 to-indigo-600 p-3 rounded-xl shadow-lg transform group-hover:scale-105 transition-all duration-300">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Banks Dashboard</h1>
                    <p class="text-sm text-gray-500">Overview of your bank accounts, balances, and recent transfers</p>
                    <p class="text-xs text-gray-400 mt-0.5">{{ $business->business_name ?? 'ExchangeHub' }}</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        ...
        {{-- Currencies In Use --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 border-l-4 border-l-sky-500 p-5 hover:shadow-md transition-all duration-300 group">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 border-l-4 border-l-indigo-500 p-5 hover:shadow-md transition-all duration-300 group">
            <div class="flex items-center gap-4">
        ...
        {{-- Total Balance --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 border-l-4 border-l-cyan-500 p-5 hover:shadow-md transition-all duration-300 group">
            <div class="flex items-center gap-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            <a href="{{ route('banks.index') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-sky-300 hover:shadow-md p-4 transition-all duration-200">
            ...
            <a href="{{ route('banks.ledger') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-emerald-300 hover:shadow-md p-4 transition-all duration-200">
            ...
            <a href="{{ route('banks.balances') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-violet-300 hover:shadow-md p-4 transition-all duration-200">
            ...
            <a href="{{ route('banks.currency-balances') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-cyan-300 hover:shadow-md p-4 transition-all duration-200">
            ...
            <a href="{{ route('bank-transfers.index') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-indigo-300 hover:shadow-md p-4 transition-all duration-200">
            ...
            <a href="{{ route('money-exchanges.index') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-amber-300 hover:shadow-md p-4 transition-all duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-2">
                    <div class="bg-gradient-to-br from-sky-500 to-indigo-600 p-1.5 rounded-lg shadow-sm">
                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                        </svg>
                    </div>
                ...
                <a href="{{ route('banks.index') }}"
                    class="group/link flex items-center gap-1 px-3 py-1.5 bg-sky-50 hover:bg-sky-100 rounded-lg border border-sky-100 hover:border-sky-200 transition-all duration-200">
                    ...
                    <a href="{{ route('banks.edit', $bank) }}"
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-xs text-gray-400">Acct: {{ $bank->account_number ?? 'N/A' }}</span>
                                <span class="px-2 py-0.5 inline-flex text-[10px] leading-5 font-semibold rounded-full {{ $bank->status == 1 ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700' }}">
            ...
            <div class="space-y-2">
                ...
                <div class="relative group/item">
                    ...
                    <a href="{{ route('bank-transfers.edit', $transfer) }}"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1">
                                <span class="text-sm font-semibold text-gray-900 group-hover/item:text-emerald-700 transition-colors truncate pr-2">

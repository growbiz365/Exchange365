<x-app-layout>
    ...
    <div class="relative backdrop-blur-xl bg-white/70 rounded-xl shadow-lg shadow-indigo-500/5 border border-white/60 p-6 mb-6 overflow-hidden">
        ...
        <div class="relative grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <a href="{{ route('banks.currency-balances') }}"
                class="group relative backdrop-blur-lg bg-white/90 rounded-xl border border-white/60 p-4 hover:shadow-xl hover:shadow-cyan-500/20 hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <a href="{{ route('bank-transfers.index') }}"
                class="group relative backdrop-blur-lg bg-white/90 rounded-xl border border-white/60 p-4 hover:shadow-xl hover:shadow-indigo-500/20 hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        <div class="relative backdrop-blur-xl bg-white/80 rounded-xl shadow-lg shadow-sky-500/5 border border-white/60 p-6 overflow-hidden group">
            ...
            <div class="relative space-y-3">
                ...
                <div class="relative group/item">
                    ...
                    @endif
                    <a href="{{ route('banks.edit', $bank) }}" class="relative flex items-start space-x-3 p-3.5 backdrop-blur-sm bg-white/90 rounded-lg border border-white/60 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 block">
                        <div class="relative flex-shrink-0">
        ...
        <div class="relative backdrop-blur-xl bg-white/80 rounded-xl shadow-lg shadow-emerald-500/5 border border-white/60 p-6 overflow-hidden group">
            ...
            <div class="relative space-y-3">
                ...
                <div class="relative group/item">
                    ...
                    @endif
                    <a href="{{ route('bank-transfers.edit', $transfer) }}" class="relative flex items-start space-x-3 p-3.5 backdrop-blur-sm bg-white/90 rounded-lg border border-white/60 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 block">
                        <div class="relative flex-shrink-0">

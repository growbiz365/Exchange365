            ...
            <div class="pb-6 mb-6 border-b border-gray-100">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-gray-500">Please provide details of the business.</p>
                    </div>
                </div>
                    ...
                    <div class="sm:col-span-1 mb-4">
                        ...
                        <select name="currency_id" id="currency_id" class="block w-full border-gray-300 rounded-md shadow-sm chosen-select @error('currency_id') border-red-500 @enderror">
                            ...
                            @foreach($currencies as $cur)
                                <option value="{{ $cur->currency_id }}" @selected(old('currency_id')==$cur->currency_id)>{{ $cur->currency }}{{ $cur->currency_symbol ? ' (' . $cur->currency_symbol . ')' : '' }}</option>
                            @endforeach
                        </select>
                        <div class="chosen-error-container">
                            @error('currency_id')

    ...
    <form action="{{ route('asset-categories.store') }}" method="POST">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-4 sm:p-6 mt-4">
            ...
            <div class="mt-6 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2 border-t border-gray-100 pt-4">
                ...
                <button type="submit" class="inline-flex items-center justify-center rounded-md bg-indigo-600 px-3 py-2.5 sm:py-2 text-sm font-semibold text-white hover:bg-indigo-500 w-full sm:w-auto">Save</button>
            </div>
        </div>
    </form>
</x-app-layout>

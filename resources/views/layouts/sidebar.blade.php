      ...
      <div class="fixed inset-0 flex"
         ...
         <div class="relative mr-16 flex w-full max-w-xs flex-1">
            ...
            <div class="flex grow flex-col overflow-hidden bg-white px-3 pb-4 shadow-xl border-r border-gray-200">
               ...
               <!-- Navigation -->
               <nav class="flex flex-1 flex-col min-h-0 pt-3">
                  <ul role="list" class="flex flex-1 flex-col gap-y-1 min-h-0">
                        ...
                        <ul role="list" class="space-y-0.5">
                           <li>
                              <a href="{{ route('dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('dashboard') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <ul role="list" class="space-y-0.5">
                           ...
                           <li>
                              <a href="{{ route('parties.dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('parties.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('banks.dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('banks.*') && !request()->routeIs('bank-transfers.*') && !request()->routeIs('general-vouchers.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('general-vouchers.index') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('general-vouchers.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('purchases.dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('purchases.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('sales.dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('sales.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('assets.dashboard') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('assets.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <ul role="list" class="space-y-0.5">
                           <li>
                              <a href="{{ route('reports.index') }}"
                                 ...
                                 <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('reports.*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                     ...
                     <li class="mt-auto pt-3 border-t border-gray-100">
                        <a href="{{ route('settings') }}"
                           ...
                           <svg class="h-4.5 w-4.5 flex-shrink-0 {{ request()->routeIs('settings') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">

<div>
      ...
      <div class="fixed inset-0 flex"
         ...
         <div class="relative mr-16 flex w-full max-w-xs flex-1">
            <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
               <button type="button" class="-m-2.5 p-2.5 text-gray-500 hover:text-gray-800 transition-colors rounded-full hover:bg-gray-100" @click="sidebarOpen = false">
            ...
            <div class="flex grow flex-col overflow-hidden bg-white px-4 pb-4 shadow-xl border-r border-gray-200">
               <!-- Logo -->
               <div class="flex h-20 shrink-0 items-center border-b border-gray-100">
                  ...
                  <ul role="list" class="flex flex-1 flex-col gap-y-2 min-h-0">
                        ...
                        <ul role="list" class="space-y-1">
                           <li>
                              <a href="{{ route('dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('dashboard') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                        ...
                        <ul role="list" class="space-y-1">
                           ...
                           <li>
                              <a href="{{ route('parties.dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('parties.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('banks.dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('banks.*') && !request()->routeIs('bank-transfers.*') && !request()->routeIs('general-vouchers.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('general-vouchers.index') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('general-vouchers.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('purchases.dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('purchases.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('sales.dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('sales.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                           ...
                           <li>
                              <a href="{{ route('assets.dashboard') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('assets.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <ul role="list" class="space-y-1">
                           <li>
                              <a href="{{ route('reports.index') }}"
                                 class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('reports.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                                 <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                     ...
                     <li class="mt-auto pt-4 border-t border-gray-200">
                        <a href="{{ route('settings') }}"
                           class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('settings') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                           <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
   ...
   <div class="sidebar-desktop hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col min-h-0" x-cloak>
      ...
      <div class="flex grow flex-col min-h-0 overflow-hidden bg-[#FFF6E8] shadow-sm border-r border-[#F5DFB8]">
         
         <!-- Logo Section with Animation -->
         <div class="flex shrink-0 items-center border-b border-[#F5DFB8] py-5 transition-[padding] duration-300"
         ...
         <nav class="flex flex-1 flex-col min-h-0 px-2 py-4">
            <ul role="list" class="flex flex-1 flex-col min-h-0 gap-y-2">
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('dashboard') }}"
                             ...
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('dashboard') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('parties.dashboard') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('parties.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('banks.dashboard') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('banks.*') && !request()->routeIs('bank-transfers.*') && !request()->routeIs('general-vouchers.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('general-vouchers.index') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('general-vouchers.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('purchases.dashboard') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('purchases.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('sales.dashboard') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('sales.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('assets.dashboard') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('assets.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-4.5L3 7.5m18 0l-9 4.5m9-4.5v9l-9 4.5M3 7.5l9 4.5M3 7.5v9l9 4.5m0-9v9" />
                             </svg>
                    ...
                    <li>
                       <div x-data="{ tooltip: false }">
                          <a href="{{ route('reports.index') }}"
                             @mouseenter="tooltip = sidebarCollapsed"
                             @mouseleave="tooltip = false"
                             class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('reports.*') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                             <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                               <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                             </svg>
              ...
              <!-- Settings -->
              @can('view settings')
              <li class="mt-auto pt-4 border-t border-[#F5DFB8]">
                 <div x-data="{ tooltip: false }">
                    <a href="{{ route('settings') }}"
                       @mouseenter="tooltip = sidebarCollapsed"
                       @mouseleave="tooltip = false"
                       class="group relative flex items-center gap-3 rounded-md px-3 py-2 text-sm font-semibold {{ request()->routeIs('settings') ? 'bg-white text-gray-900 shadow-sm border border-orange-100' : 'text-gray-600 hover:bg-[#FDEBD0] hover:text-gray-900' }}">
                       <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                         <path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z"/>
                         <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                       </svg>

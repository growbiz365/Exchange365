        ...
        <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-4">
                <div class="relative flex-shrink-0">
                    <div class="relative bg-gradient-to-br from-emerald-500 to-teal-600 p-3 rounded-xl shadow-lg">
                ...
                <div>
                    <h1 class="text-2xl font-bold bg-gradient-to-r from-gray-900 via-emerald-800 to-teal-900 bg-clip-text text-transparent">
                        Sales #{{ $sale->sales_id }}
                    </h1>
        ...
        <div class="relative overflow-hidden rounded-xl shadow-lg border border-rose-100 bg-gradient-to-br from-rose-50/90 via-white to-rose-50/50">
            <div class="relative p-6">
                <div class="flex items-center gap-3 mb-5 pb-4 border-b border-rose-200/60">
                    ...
                    <div>
                        <h2 class="text-sm font-bold uppercase tracking-wide text-rose-800">Withdrawal from Bank ( جمع )</h2>
                    </div>
                </div>
                <dl class="space-y-4">
                    <div>
            ...
            <div class="relative p-6">
                ...
                <dl class="space-y-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <span class="inline-flex px-2.5 py-1 text-xs font-semibold rounded {{ $sale->transaction_operation === \App\Models\Sale::TRANSACTION_MULTIPLY ? 'bg-amber-100 text-amber-800' : 'bg-sky-100 text-sky-800' }}">
                    ...
                    <div class="pt-2">
                        ...
                        <dd class="mt-1 text-sm text-gray-700 bg-gray-50 rounded-lg p-3 border border-gray-100">{{ $sale->details }}</dd>
                    </div>
                    @endif
                </dl>
            </div>
        ...
        <div class="relative overflow-hidden rounded-xl shadow-lg border border-emerald-100 bg-gradient-to-br from-emerald-50/90 via-white to-emerald-50/50">
            <div class="relative p-6">
                <div class="flex items-center gap-3 mb-5 pb-4 border-b border-emerald-200/60">
                    ...
                    <div>
                        <h2 class="text-sm font-bold uppercase tracking-wide text-emerald-800">Party ( جمع )</h2>
                    </div>
                </div>
                <dl class="space-y-4">
                    <div>

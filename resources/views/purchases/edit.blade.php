<x-app-layout>
    ...
    <x-dynamic-heading title="Update Purchase #{{ $purchase->purchase_id }}" />
            ...
            <div class="p-4 border-b border-gray-100">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="date" id="date_added" name="date_added" value="{{ old('date_added', $purchase->date_added->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 mt-0.5">
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="transaction_operation" value="2" {{ old('transaction_operation', $purchase->transaction_operation) == '2' ? 'checked' : '' }} required
                                    class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                <span class="text-sm text-gray-700">Multiply</span>
                            </label>
                            <label class="inline-flex items-center gap-1.5 cursor-pointer">
                                <input type="radio" name="transaction_operation" value="1" {{ old('transaction_operation', $purchase->transaction_operation) == '1' ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                    ...
                    <div>
                        ...
                        <input type="number" id="rate" name="rate" step="0.0001" value="{{ old('rate', $purchase->rate) }}" required placeholder="1"
                            class="block w-full rounded-lg border-gray-300 text-sm py-2 focus:border-indigo-500 focus:ring-indigo-500" />
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="details" name="details" value="{{ old('details', $purchase->details) }}" placeholder="Optional notes..."
                            class="block w-full rounded-lg border-gray-300 text-sm py-2 focus:border-indigo-500 focus:ring-indigo-500" />
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-white border-r border-gray-100 p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input type="number" id="credit_amount" name="credit_amount" step="0.01" value="{{ old('credit_amount', $purchase->credit_amount) }}" required placeholder="0.00"
                ...
                <div class="bg-gradient-to-br from-indigo-50 to-white p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input type="number" id="debit_amount" name="debit_amount" step="0.01" value="{{ old('debit_amount', $purchase->debit_amount) }}" required placeholder="0.00"

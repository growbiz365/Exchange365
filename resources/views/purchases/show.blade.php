<x-app-layout>
        ...
        <div class="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div class="flex items-start gap-3 sm:space-x-4 min-w-0">
                <div class="flex-shrink-0">
                    <div class="bg-gradient-to-br from-amber-500 to-orange-600 p-2.5 sm:p-3 rounded-xl shadow-lg transform group-hover:scale-105 transition-transform duration-300">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 leading-tight">Purchase #{{ $purchase->purchase_id }}</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 w-full lg:w-auto lg:shrink-0">
                ...
                <a href="{{ route('purchases.edit', $purchase) }}"
                    class="inline-flex justify-center items-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:from-amber-600 hover:to-orange-700 transition w-full sm:w-auto">
                ...
                <form action="{{ route('purchases.destroy', $purchase) }}" method="POST" class="w-full sm:w-auto"
    ...
    <div class="flex flex-col-reverse sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-3">
        <a href="{{ route('purchases.index') }}" class="inline-flex items-center justify-center sm:justify-start text-sm font-medium text-gray-600 hover:text-gray-900 transition w-full sm:w-auto">
            <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
            Back to Purchase list
        </a>
        <a href="{{ route('purchases.edit', $purchase) }}" class="inline-flex items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 px-4 py-2.5 sm:py-2 text-sm font-semibold text-white shadow-sm hover:from-amber-600 hover:to-orange-700 transition w-full sm:w-auto">Edit purchase</a>
    </div>
</x-app-layout>

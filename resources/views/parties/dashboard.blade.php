    ...
    <div class="relative bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5 mt-4 overflow-hidden group">
        ...
        <div class="relative flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Parties Dashboard</h1>
                    <p class="text-sm text-gray-500">Overview of your parties, balances, and recent activity</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            <a href="{{ route('parties.currency') }}"
                class="group/card flex flex-col items-center text-center gap-2 bg-gray-50 hover:bg-white rounded-xl border border-gray-200 hover:border-rose-300 hover:shadow-md p-4 transition-all duration-200">
                    ...
                    <a href="{{ route('parties.show', $party) }}"
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 mb-1.5">
                                ...
                                <span class="ml-2 text-gray-400">Since {{ $party->opening_date->format('d M Y') }}</span>
                            </p>
            ...
            <div class="space-y-2">
                ...
                <div class="relative group/item">
                    ...
                    <a href="{{ route('party-transfers.edit', $transfer) }}"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1">
                                <span class="text-sm font-semibold text-gray-900 group-hover/item:text-sky-700 transition-colors truncate pr-2">

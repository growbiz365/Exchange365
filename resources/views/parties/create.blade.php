<x-app-layout>
    @section('title', 'Add Party - Party Management - ExchangeHub')
    <x-breadcrumb :breadcrumbs="[['url' => '/', 'label' => 'Home'],  ['url' => route('parties.dashboard'), 'label' => 'Parties Dashboard'],['url' => route('parties.index'), 'label' => 'Parties'], ['url' => '#', 'label' => 'Add Party']]" />
        ...
        <div class="bg-gray-100 shadow-sm sm:rounded-lg border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="party_name" name="party_name" value="{{ old('party_name') }}" required class="uppercase" />
                ...
                <div>
                    ...
                    <x-text-input id="contact_no" name="contact_no" value="{{ old('contact_no') }}" data-mask="0000-0000000" placeholder="03XX-XXXXXXX" />
                ...
                <div>
                    ...
                    <x-text-input id="opening_date" type="date" name="opening_date" value="{{ old('opening_date', date('Y-m-d')) }}" required />
        ...
        <div class="bg-gray-100 shadow-sm sm:rounded-lg border border-gray-200 p-6 mt-6">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Add opening balances for different currencies (optional)</p>
                </div>

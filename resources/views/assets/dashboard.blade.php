<x-app-layout>
        ...
        <div class="relative flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0">
                    <div class="bg-gradient-to-br from-slate-800 to-amber-600 p-3 rounded-xl shadow-lg transform group-hover:scale-105 transition-all duration-300">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Assets Dashboard</h1>
                    <p class="text-sm text-gray-500">Overview of your business assets, status, and recent activity</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        {{-- Total Assets --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 border-l-4 border-l-slate-700 p-5 hover:shadow-md transition-all duration-300 group">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('assets.index') }}"
                class="group/link flex items-center gap-1 px-3 py-1.5 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-200">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        @foreach($recentAssets as $asset)
                            <tr class="hover:bg-amber-50/30 transition-colors duration-150">
                                ...
                                <td class="px-4 py-2.5 text-sm text-gray-600">{{ $asset->category?->asset_category ?? '—' }}</td>
                                <td class="px-4 py-2.5 text-sm font-medium text-gray-900">{{ $asset->asset_name }}</td>

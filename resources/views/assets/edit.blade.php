    ...
    <form action="{{ route('assets.update', $asset) }}" method="POST" id="assetForm">
        ...
        <div class="relative backdrop-blur-xl bg-white/80 rounded-xl shadow-lg border border-white/60 overflow-hidden">
            ...
            <div class="p-4 border-b border-gray-100">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" id="date_added" name="date_added" value="{{ old('date_added', $asset->date_added->format('Y-m-d')) }}" required
                            class="block w-full rounded-lg border-gray-300 text-sm py-2 focus:border-indigo-500 focus:ring-indigo-500" />
                    ...
                    <div>
                        ...
                        <input type="text" id="asset_name" name="asset_name" value="{{ old('asset_name', $asset->asset_name) }}" required placeholder="Asset name"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="cost_amount" name="cost_amount" value="{{ old('cost_amount', $asset->cost_amount) }}" required placeholder="0.00"
                            class="block w-full rounded-lg border-gray-300 text-sm py-2 focus:border-indigo-500 focus:ring-indigo-500" />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea id="purchase_details" name="purchase_details" rows="2" placeholder="Optional notes..."
                            class="block w-full rounded-lg border-gray-300 text-sm py-2 focus:border-indigo-500 focus:ring-indigo-500">{{ old('purchase_details', $asset->purchase_details) }}</textarea>
            ...
            <div class="flex items-center justify-end gap-2 p-4 bg-gray-50/50 border-t border-gray-100">
                ...
                <button type="submit" id="submitBtn" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700">Update</button>
            </div>
        </div>
    </form>

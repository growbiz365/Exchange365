            ...
            <div class="bg-white shadow rounded-lg border border-gray-200 p-4">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="number" id="rate" name="rate" step="0.0001" value="{{ old('rate', '1') }}" required
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="transaction_operation" value="2" {{ old('transaction_operation') == '2' ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" onchange="calculateCreditAmount()" />
        ...
        <div class="bg-white shadow rounded-lg border border-gray-200 p-4 mt-4">
            <div class="border rounded-lg p-4 bg-gray-50">
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500">Upload relevant documents (PDF, DOC, DOCX, JPG, PNG, XLS, XLSX - Max 5MB each)</p>
                </div>
            ...
            <div class="mt-6 pb-4 border-b border-gray-200">
                ...
                <p class="text-xs text-gray-500">Add notes and supporting documents</p>
            </div>
            ...
            <div class="mt-4">
                ...
                <textarea id="details" name="details" rows="3"
                    class="block w-full rounded border-gray-300 text-xs focus:border-indigo-500 focus:ring-indigo-500"
                    placeholder="Enter any additional details or notes...">{{ old('details') }}</textarea>

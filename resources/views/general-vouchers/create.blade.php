<x-app-layout>
    ...
    <div class="bg-white shadow-sm rounded-xl border border-gray-200 mt-4">
        ...
        <form method="POST" action="{{ route('general-vouchers.store') }}" enctype="multipart/form-data" id="voucherForm" class="px-4 sm:px-6 py-2 pb-3 space-y-1.5">
            @csrf
                ...
                <table class="w-full border border-gray-300 text-xs rounded">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="py-1.5 px-3">
                                <input type="number" id="amount" name="amount" step="any" value="{{ old('amount') }}" required

<x-app-layout>
    @section('title', 'Bank Transfers List - Bank Management - ExchangeHub')
    <x-breadcrumb :breadcrumbs="[
        ['url' => route('dashboard'), 'label' => 'Home'],
        ['url' => route('banks.dashboard'), 'label' => 'Bank Management'],
        ['url' => '#', 'label' => 'Bank Transfers'],
    ]" />
        ...
        <tbody>
            @forelse($transfers as $transfer)
                ...
                >
                    ...
                    <x-table-cell>
                        {{ strtoupper($transfer->toBank?->bank_name ?? '-') }}
                    </x-table-cell>
            ...
            @empty
                <tr>
                    <x-table-cell colspan="6" class="text-center text-gray-500">No transfers found</x-table-cell>
                </tr>
            @endforelse
        </tbody>
    </x-table-wrapper>

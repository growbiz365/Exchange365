<x-app-layout>
    ...
    <div class="bg-white border border-gray-200 shadow-lg sm:rounded-xl p-4">
        <div class="mb-4">
            ...
            <p class="text-xs text-gray-600">Update the transfer information below.</p>
        </div>
        ...
        <form method="POST" action="{{ route('bank-transfers.update', $bankTransfer) }}" enctype="multipart/form-data" id="transferForm">
            @csrf
            @method('PUT')
